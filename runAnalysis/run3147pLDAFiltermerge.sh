...
cat results/run3197pM3FilterOnly.dat >> results/run3147pM3FilterMerge.dat
cat results/run3203pM3FilterOnly.dat >> results/run3147pM3FilterMerge.dat
cat results/run3204pM3FilterOnly.dat >> results/run3147pM3FilterMerge.dat
cat results/run3205pM3FilterOnly.dat >> results/run3147pM3FilterMerge.dat
