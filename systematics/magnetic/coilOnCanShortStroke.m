...
[lrDiff blBins blH brBins brH bLPositions bRPositions] = compareTwoSquareWavesBlind( bL,bR, torCol, torerrCol, torErrThresh, torErrMin, psSquareCol, numSensors, 1, 2);
[r0Diff brBins brH b0Bins b0H bRPositions b0Positions] = compareTwoSquareWavesBlind( bR,b0, torCol, torerrCol, torErrThresh, torErrMin, psSquareCol, numSensors, 1, 2);
