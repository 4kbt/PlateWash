...
preans = factors *  (...
		pa1  * repmat(Atten2 , length(position), 1).* ( ...
			ph1 * yukawaAngleCore( lambda, theta,    j1, w1/2, a1)   .* ( exp( -( position			)'	* (1./lambda )) ) + ...
			ph1 * yukawaAngleCore( lambda, theta, -w1/2,  -j1, a1)   .* ( exp( -( position + thickness1 - a1)'	* (1./lambda )) ) + ...
			pl1 * yukawaAngleCore( lambda, theta, -w1/2,  -j1, a1)   .* ( exp( -( position 			)'	* (1./lambda )) ) + ...
			pl1 * yukawaAngleCore( lambda, theta,    j1, w1/2, a1)   .* ( exp( -( position + thickness1 - a1)'	* (1./lambda )) ) + ...
			pl1 * yukawaAngleCore( lambda, theta, -w1/2, w1/2, a1)   .* ( exp( -( position + a1		)'	* (1./lambda )) ) + ...
			0
		) + ... 
		pal1  * repmat(Atten2l , length(position), 1).* ( ...
			ph1 * yukawaAngleCore( lambda, theta,    j1, w1/2, a1)   .* ( exp( -( position 			 + da1)'* (1./lambda )) ) + ...
			ph1 * yukawaAngleCore( lambda, theta, -w1/2,  -j1, a1)   .* ( exp( -( position + thickness1 - a1 + da1)'* (1./lambda )) ) + ...
			pl1 * yukawaAngleCore( lambda, theta, -w1/2,  -j1, a1)   .* ( exp( -( position 			 + da1)'* (1./lambda )) ) + ...
			pl1 * yukawaAngleCore( lambda, theta,    j1, w1/2, a1)   .* ( exp( -( position + thickness1 - a1 + da1)'* (1./lambda )) ) + ...
			pl1 * yukawaAngleCore( lambda, theta, -w1/2, w1/2, a1)   .* ( exp( -( position + a1		 + da1)'* (1./lambda )) ) + ...
			0
		) ... 
		) ;
